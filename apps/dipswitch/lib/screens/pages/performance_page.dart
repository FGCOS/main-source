...
import 'package:dipswitch/widgets/subtitle.dart';
    ...
    return ScaffoldPage.scrollable(
      ...
      children: [
        CardHighlightSwitch(
          ...
          label: FGCOSLocalizations.of(context).perfSuperfetchLabel,
          description: FGCOSLocalizations.of(context).perfSuperfetchDescription,
          switchBool: sfBool,
          function: (value) async {
            ...
            showDialog(
              ...
              builder: (context) => ContentDialog(
                content: Text(FGCOSLocalizations.of(context).restartDialog),
                actions: [
                  Button(
        ...
        if (sfBool) ...[
          CardHighlightSwitch(
            ...
            label: FGCOSLocalizations.of(context).perfMCLabel,
            description: FGCOSLocalizations.of(context).perfMCDescription,
            switchBool: mcBool,
            function: (value) {
              setState(() {
                mcBool = value;
        ...
        CardHighlightSwitch(
          ...
          label: FGCOSLocalizations.of(context).perfITSXLabel,
          description: FGCOSLocalizations.of(context).perfITSXDescription,
          switchBool: iTSXBool,
          function: (value) async {
            setState(() {
              iTSXBool = value;
        ...
        CardHighlightSwitch(
          ...
          label: FGCOSLocalizations.of(context).perfFOLabel,
          description: FGCOSLocalizations.of(context).perfFODescription,
          switchBool: foBool,
          function: (value) async {
            setState(() {
              foBool = value;
        ...
        if (w11) ...[
          CardHighlightSwitch(
            ...
            label: FGCOSLocalizations.of(context).perfOWGLabel,
            description: FGCOSLocalizations.of(context).perfOWGDescription,
            switchBool: owgBool,
            function: (value) {
              setState(() {
                owgBool = value;
        ...
        if (expBool) ...[
          CardHighlightSwitch(
            ...
            label: FGCOSLocalizations.of(context).perfCStatesLabel,
            description: FGCOSLocalizations.of(context).perfCStatesDescription,
          ...
          subtitle(content: Text(FGCOSLocalizations.of(context).perfSectionFS)),
          CardHighlightSwitch(
            icon: msicons.FluentIcons.document_bullet_list_clock_20_regular,
            label: FGCOSLocalizations.of(context).perfLTALabel,
            description: FGCOSLocalizations.of(context).perfLTADescription,
          ...
          CardHighlightSwitch(
            ...
            label: FGCOSLocalizations.of(context).perfEdTLabel,
            description: FGCOSLocalizations.of(context).perfEdTDescription,
          ...
          CardHighlightSwitch(
            ...
            label: FGCOSLocalizations.of(context).perfMULabel,
            ...
            codeSnippet: FGCOSLocalizations.of(context).perfMUDescription,
          ),
        ]
      ],
    );

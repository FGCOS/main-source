    ...
    return ScaffoldPage.scrollable(
      header: PageHeader(
        title: Padding(
          ...
          child: Text(FGCOSLocalizations.of(context).pageSecurity),
        ),
      ),
      children: [
        Visibility(
          ...
          replacement: CardHighlightSwitch(
            ...
            label: FGCOSLocalizations.of(context).securityWDLabel,
            description: FGCOSLocalizations.of(context).securityWDDescription,
            switchBool: wdBool,
              ...
              child: Button(
                onPressed: () async {
                  ...
                  showDialog(
                    ...
                    builder: (context) => ContentDialog(
                      content:
                          Text(FGCOSLocalizations.of(context).securityDialog),
                      actions: [
                        Button(
                          child: Text(FGCOSLocalizations.of(context).okButton),
                          onPressed: () {
                ...
                child: Text(FGCOSLocalizations.of(context).securityWDButton),
              ),
            ),
          ),
        ),
        ...
        //                 InfoLabel(
        //                     label:
        //                         FGCOSLocalizations.of(context).securityWDLabel),
        //                 Text(
        //                   FGCOSLocalizations.of(context).securityWDDescription,
        ...
        //           context: context,
        //           builder: (context) => ContentDialog(
        //             content: Text(FGCOSLocalizations.of(context).securityDialog),
        //             actions: [
        //               Button(
        //                 child: Text(FGCOSLocalizations.of(context).okButton),
        //                 onPressed: () async {
        ...
        //                     builder: (context) => ContentDialog(
        //                       content: Text(
        //                           FGCOSLocalizations.of(context).restartDialog),
        //                       actions: [
        //                         Button(
        //                           child: Text(
        //                               FGCOSLocalizations.of(context).okButton),
        //                           onPressed: () {
        //                             Navigator.pop(context);
        //                           },
        //                         ),
        ...
        CardHighlightSwitch(
          ...
          label: FGCOSLocalizations.of(context).securityUACLabel,
          description: FGCOSLocalizations.of(context).securityUACDescription,
          switchBool: uacBool,
          function: (value) async {
            setState(() {
              uacBool = value;
        ...
        CardHighlightSwitch(
          ...
          label: FGCOSLocalizations.of(context).securitySMLabel,
          description: FGCOSLocalizations.of(context).securitySMDescription,
          switchBool: smBool,
          function: (value) async {
            setState(() {
              smBool = value;

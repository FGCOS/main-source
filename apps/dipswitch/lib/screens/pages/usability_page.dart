    ...
    return ScaffoldPage.scrollable(
      ...
      children: [
        CardHighlightSwitch(
          ...
          label: FGCOSLocalizations.of(context).usabilityNotifLabel,
          description: FGCOSLocalizations.of(context).usabilityNotifDescription,
        ...
        if (_notifBool) ...[
          CardHighlightSwitch(
            ...
            label: FGCOSLocalizations.of(context).usabilityLBNLabel,
            description: FGCOSLocalizations.of(context).usabilityLBNDescription,
        ...
        CardHighlightSwitch(
          ...
          label: FGCOSLocalizations.of(context).usabilityITPLabel,
          description: FGCOSLocalizations.of(context).usabilityITPDescription,
          switchBool: _itpBool,
          function: (value) async {
            setState(() {
              _itpBool = value;
        ...
        CardHighlightSwitch(
          ...
          label: FGCOSLocalizations.of(context).usabilityCPLLabel,
          switchBool: _cplBool,
          function: (value) async {
            setState(() {
              _cplBool = value;

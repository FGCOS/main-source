...
class _UsabilityPageTwoState extends State<UsabilityPageTwo> {
  ...
  Widget build(BuildContext context) {
    return ScaffoldPage.scrollable(
      header: PageHeader(
        title: Text(
            '${FGCOSLocalizations.of(context).pageUsability} > Windows 11'),
      ),
      children: [
        CardHighlightSwitch(
          icon: msicons.FluentIcons.document_one_page_20_regular,
          label: FGCOSLocalizations.of(context).usability11MRCLabel,
          switchBool: mrcBool,
        ...
        CardHighlightSwitch(
          ...
          label: FGCOSLocalizations.of(context).usability11FETLabel,
          switchBool: fetBool,
          function: (value) async {
            setState(() {
              fetBool = value;
